                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="glasses.html">Nuestros drops</a>
                              </li>
                              <li class="nav-item">
               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="text-bg">
                           <h1> <span class="blu">Bienvenido <br></span>A Nexus Clothing</h1>
                           <figure><img class="logo" src="images/Nexus.png" alt="#"/></figure>
            ...
            <div class="row d_flex">
               ...
               <div class="col-md-7">
                  <div class="titlepage">
                     ...
                     <p>Sabemos que existen miles de marcas de "Street Wear", por lo que en Nexus, decidimos innovar sobre este concepto, trayendo diseños sobre la cultura Prehispanica para ennorgullesernos de nuestras raíces.</p>
                  </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  <div class="titlepage">
                     <h2>Nuestros Drops</h2>
                     <p>Aquí puedes ver todas nuestras piezas disponibles
                     </p>
                  </div>
               </div>
            </div>
